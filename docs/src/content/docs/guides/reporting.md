---
title: Reporting
description: Read-only dialect-aware aggregate queries for SaaS metrics such as MRR, subscription counts, and feature adoption.
---
...
- [Audit & events](/saas-billing/guides/audit-events/) — the compliance side of the same data.
