...
description: Manual invoicing, offline payment recording, and the append-only customer credit ledger.
---
...
<Tabs>
  <TabItem label="From a subscription">
...
- [Partners & channel](/saas-billing/guides/partners/) — partner invoices, payments, and payouts.
- [Reporting](/saas-billing/guides/reporting/) — outstanding invoices and receivables.
