---
title: Audit & events
description: Append-only audit logging and the transactional outbox used for webhook delivery.
---
...
- [Errors](/saas-billing/reference/errors/) — the typed error hierarchy your handlers should catch.
