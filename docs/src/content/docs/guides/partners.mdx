...
description: Sell through distributors, agents, and resellers with licenses, commission rules, allocations, and partner ledgers.
---
...
<Tabs>
  <TabItem label="`wholesale_prepaid`">
...
**receivable** account (the partner owes the wholesale amount).
  ...
  <TabItem label="`agency_commission`">
...
:::caution[Revocation does not reverse the ledger]
...
```
  ...
  <TabItem label="Partner invoices">
...
Revoked licenses are excluded. See [Reporting](/saas-billing/guides/reporting/).

## Next

- [REST endpoints](/saas-billing/reference/rest-api/) for the full partner HTTP surface.
- [Data model](/saas-billing/reference/data-model/) for the partner tables.
