...
description: The full HTTP surface of the billing engine, covering customers, catalog, subscriptions, entitlements, invoices, reports, audit, and partners.
---
...
[Errors](/saas-billing/reference/errors/).
