...
description: Run the billing engine in-process, sharing your application's database connection with no extra service.
---
...
- [Command line](/saas-billing/deployment/cli/)
- [Standalone & REST](/saas-billing/deployment/rest/)
