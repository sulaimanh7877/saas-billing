...
description: How the engine stamps every table, key, constraint, and index with a single required, configurable table prefix.
---
...
[ADR 0001](/saas-billing/adr/0001-prefix-strategy/).
